                    ...
                    <div className="p-1">
                      {subscriptionTier === PRICING_TIER_PRODUCT_IDS.FREE ? (
                        ...
                        <div className="space-y-4">
                          <p>
                            Your project is currently on the Pro tier with Usage Cap enabled. When
                          ...
                          <Link href={`/project/${projectRef}/settings/billing/update/pro`}>
                            <Button>Configure Usage Cap</Button>
                          </Link>
                        </div>
                      )}
                    </div>
                      ...
                      <Alert title={'Database is in read-only mode'} variant="danger" withIcon>
                        <p>
                          {isPaidTier ? (
                            ...
                            <>
                              You have exceeded the 500mb Database size limit and your project is
                              now in{' '}
                              <a
                        ...
                        {isPaidTier ? (
                          <>
                            ...
                            <p className="mt-2">
                              If you require help or need your disk changed to read/write mode so
                              you can delete data,{' '}
                              <Link
