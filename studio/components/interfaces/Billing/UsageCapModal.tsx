...
const UsageCapModal: FC<Props> = ({ visible, onHide }) => {
  return (
    <Modal
      hideFooter
      visible={visible}
      size="xlarge"
      header="Enabling usage cap"
      onCancel={() => onHide()}
    >
      <div className="py-4 space-y-4">
        <Modal.Content>
          <div className="space-y-4">
            <p className="text-sm">
              With the usage cap enabled, you cannot go above your plans included quota. While this
              gives you control over costs, it may restrict your service. Disabling the usage cap
            ...
            {/* Maybe instead of a table, show something more interactive like a usage cap playground */}
