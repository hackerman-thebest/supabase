            ...
            <div className="!mt-4 space-y-4">
              ...
              {togglingOnUsageCap && (
                <InformationBox
                  ...
                  description="If you go past your plan's quota, you will experience service restrictions. When the usage cap is off, you will simply be charged for overusage."
                />
              )}
            </div>
          </div>
